...
${body}
  ...
  function refreshStaticUI() {
    ...
    /*
     * i18n.js already translates all
     * [data-i18n] elements.
     *
     * We deliberately do NOT maintain
     * another translation dictionary here.
     */
  ...
  console.log(
    `[File Converter] Initialized successfully. Language: ${getLanguage()}`
  );
